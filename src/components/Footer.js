            ...
            <footer className="footer p-8 md:p-10 2xl:p-12 text-white max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 2xl:gap-12 w-full">
                    ...
                    <div className="space-y-4 md:space-y-6 2xl:space-y-8">
                        <h3 className="text-3xl md:text-4xl 2xl:text-5xl font-bold mb-6 2xl:mb-8 border-b border-accent/30 pb-2 2xl:pb-4" style={{ fontFamily: "'Mr Dafoe', cursive" }}>Luso Delights</h3>
                    ...
                    <div className="grid grid-cols-2 gap-8 2xl:gap-10 3xl:gap-12">
                        <div>
                            <h4 className="text-xl 2xl:text-2xl font-semibold mb-4 2xl:mb-6 border-b border-accent/30 pb-2 2xl:pb-3">Site</h4>
                            ...
                            <h4 className="text-xl 2xl:text-2xl font-semibold mb-4 2xl:mb-6 border-b border-accent/30 pb-2 2xl:pb-3">Legal</h4>
                        ...
                        {/* Social Links */}
                        <div>
                            <h4 className="text-xl 2xl:text-2xl font-semibold mb-4 2xl:mb-6 border-b border-accent/30 pb-2 2xl:pb-3">Connect</h4>
                    ...
                    <div>
                        <h4 className="text-xl 2xl:text-2xl font-semibold mb-4 2xl:mb-6 border-b border-accent/30 pb-2 2xl:pb-3">About Us</h4>
                        ...
                        <h4 className="text-xl 2xl:text-2xl font-semibold mb-4 2xl:mb-6 border-b border-accent/30 pb-2 2xl:pb-3">Newsletter</h4>
